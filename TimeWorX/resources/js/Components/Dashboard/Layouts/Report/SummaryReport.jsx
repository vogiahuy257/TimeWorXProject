...
export default function SummaryReport({ auth }) {
    return (
        <section className='custom-sumary-report h-full'>
                <button className='btn flex justify-center items-center gap-1 rounded-md absolute top-2 right-4'>
                    <p>Create</p>
            ...
            <div className='w-full h-full bg-while overflow-y-auto max-h-[510px] scrollbar-hide rounded-md mt-8'>
                <h1>dashkajd</h1>
                <br/>
                <h1>dashkajd</h1>
                <h1>dashkajd</h1>
