...
export default function CardProject({ project, formatDateRange, handleDelete }) {
    return (
        <div className={`card ${project.project_status || 'verify'}`} key={project.project_id}>
            ...
            <div className='card-header'>
                ...
                <div className='card-form'>
                    ...
                    <Link className='card-form-edit' to={`/projects/${project.project_id}/edit`}>
