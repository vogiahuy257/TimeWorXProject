        ...
        <div className="user-list-overlay">
            <div className="user-list-modal">
                ...
                <div className='user-list-active mr-2'>
                    <h2 className='text-lg px-4 py-2'>List of users in the project</h2>
                    <ul className="user-list space-y-3 mt-14">
                        {users.length > 0 ? (
                            users.map((user) => (
                                <li className='custom-li flex items-center justify-between rounded-md p-2' key={user.id}>
                ...
                <div className='user-list-search'>
                    <h2 className='text-lg px-4 py-2'>List of Users</h2>
                    <div className='mt-10'>
                    <input
                        type="text"
